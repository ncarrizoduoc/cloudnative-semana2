...
public class CursoController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<Curso> buscarCurso(@PathVariable @PositiveOrZero int id){
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Curso> modificarCurso(@PathVariable @PositiveOrZero int id, @Valid @RequestBody Curso curso){
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> eliminarCurso(@PathVariable @PositiveOrZero int id){
