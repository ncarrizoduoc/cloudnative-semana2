...
public class EstudianteController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<Estudiante> buscarEstudiante(@PathVariable @PositiveOrZero int id){
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Estudiante> modificarEstudiante(@PathVariable @PositiveOrZero int id, @Valid @RequestBody Estudiante estudiante){
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> eliminarEstudiante(@PathVariable @PositiveOrZero int id){
